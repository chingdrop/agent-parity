...
from agent_parity.reporting.splunk_export import BATCH_SIZE, SplunkExportError, send_deltas
...
def test_disabled_when_unconfigured_makes_no_request(monkeypatch):
    monkeypatch.setattr("agent_parity.reporting.splunk_export.requests.post", _refuse_to_post)
...
def test_posts_correctly_shaped_hec_envelope(monkeypatch):
    ...
    monkeypatch.setattr("agent_parity.reporting.splunk_export.requests.post", fake_post)
