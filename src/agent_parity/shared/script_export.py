...
:class:`~agent_parity.shared.remote_exec.VendorConnector` and return its output,
...
URL (:class:`agent_parity.shared.storage.ObjectStorage`) and fetches the real
...
from agent_parity.shared.remote_exec import VendorConnector
